 ...
 * @author Niloy
 */
public class stuffHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cafeButton.setFont(new java.awt.Font("Ebrima", 1, 36)); // NOI18N
        cafeButton.setText("EDIT CAFETERIA MENU");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(logoutButton)
                .addGap(171, 171, 171)
                .addComponent(cafeButton, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(245, 245, 245)
    ...
    private void cafeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cafeButtonActionPerformed
       // TODO add your handling code here:
        new editMenu(user).setVisible(true);
        this.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stuffHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
